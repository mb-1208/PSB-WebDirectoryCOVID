<html lang="zxx" class="no-js" style="display: block;"><head>
		...
		<body style="display: block;"><button type="button" id="mobile-nav-toggle"><i class="lnr lnr-menu"></i></button>	
				  		...
				  		<div class="row align-items-center">
				  			...
				  			<div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
								<a class="btns" href="tel:+62 893 8881 1333">+62 893 8881 1333</a>
				  				<a class="btns" href="lontarlab.com">lontarlab.com</a>		
			...
			<section class="banner-area relative" id="home" style="background-color:#20639B">
				...
				<div class="container">
					<div class="row fullscreen d-flex justify-content-center align-items-center" style="height: 696px;">
						<div class="banner-content col-lg-9 col-md-12 justify-content-center">
							<h6 class="text-uppercase">Menyediakan informasi terupdate dan terpecaya</h6>
							<h1>
								COVPEDIA			
							</h1>
							<p class="text-white mx-auto">
								Informasi seputar perkembangan COVID-19 dibeberapa rumah sakit yang menjadi tempat untuk pemulihan dan penanganan bagi Pasien COVID-19.
							</p>
						</div>											
					</div>
				</div>
			...
			<!-- Start blog Area -->
			<section class="blog-area section-gap pad-lay" id="blog" style="padding-bottom: 40px">
				<div class="container">
...
Copyright ©<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="https://lontarlab.com" target="_blank">Lontarlab</a></p>
	...
	<nav id="mobile-nav">
				      ...
				      </nav><div id="mobile-body-overly"></div><div id="ui-datepicker-div" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>
                    </body>
                </html>